      ...
      >
        ...
        >
          {file.file_type.startsWith("image") ? (
            ...
            <FileWordOutlined style={{ fontSize: 42, color: "#1677ff" }} />
          ) : file.file_type.includes("excel") ||
            file.file_type.includes("spreadsheet") ? (
            <FileExcelOutlined style={{ fontSize: 42, color: "#52c41a" }} />
          ) : file.file_type.includes("video") ||
            file.file_type.startsWith("video/") ? (
            <PlayCircleOutlined style={{ fontSize: 42, color: "#722ed1" }} />
          ) : file.file_type.includes("audio") ||
            file.file_type.startsWith("audio/") ? (
            <AudioOutlined style={{ fontSize: 42, color: "#fa8c16" }} />
          ) : (
