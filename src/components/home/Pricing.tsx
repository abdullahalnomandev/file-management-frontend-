...
const pricingPlans = [
  {
    ...
    name: "free",
    total_max_folder: 5,
    max_nesting_folder: 3,
    allowed_file_type: ["image/jpeg", "image/pdf", "image/jpg"],
    max_file_size: 7,
    total_file_limit: 50,
    file_per_folder_limit: 5,
    created_at: "2026-03-01T13:36:13.303Z",
    updated_at: "2026-03-01T13:36:13.303Z"
  },
  {
    id: 2,
    name: "silver",
    total_max_folder: 20,
    max_nesting_folder: 3,
    allowed_file_type: ["image", "video", "pdf"],
    max_file_size: 25,
    total_file_limit: 300,
    file_per_folder_limit: 50,
    created_at: "2026-03-01T13:36:33.699Z",
    updated_at: "2026-03-01T13:36:33.699Z"
  },
  {
    id: 3,
    name: "gold",
    total_max_folder: 50,
    max_nesting_folder: 5,
    allowed_file_type: ["image", "video", "pdf", "audio"],
    max_file_size: 100,
    total_file_limit: 1000,
    file_per_folder_limit: 200,
    created_at: "2026-03-01T13:37:10.416Z",
    updated_at: "2026-03-01T13:37:10.416Z"
  },
  {
    id: 4,
    name: "diamond",
    total_max_folder: 200,
    max_nesting_folder: 10,
    allowed_file_type: ["image", "video", "pdf", "audio"],
    max_file_size: 500,
    total_file_limit: 10000,
    file_per_folder_limit: 1000,
    created_at: "2026-03-01T13:57:01.445Z",
    updated_at: "2026-03-01T13:57:01.445Z"
  }
];
...
const Pricing = () => {
  ...
  return (
    <section id="pricing" className="py-20 px-4 bg-[linear-gradient(180deg,#F5F5F5_0%,#FFFFFF_100%)]">
      <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <span className="text-gray-900 font-medium">{plan.total_max_folder}</span>
                ...
                <div className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-green-500 shrink-0 mt-0.5" />
                  <div>
                    <span className="text-gray-900 font-medium">{plan.max_nesting_folder}</span>
                ...
                <div className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-green-500 shrink-0 mt-0.5" />
                  <div>
                    <span className="text-gray-900 font-medium">{plan.max_file_size}MB</span>
                ...
                <div className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-green-500 shrink-0 mt-0.5" />
                  <div>
                    <span className="text-gray-900 font-medium">{plan.total_file_limit}</span>
                ...
                <div className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-green-500 shrink-0 mt-0.5" />
                  <div>
                    <span className="text-gray-900 font-medium">{plan.file_per_folder_limit}</span>
        ...
        <div className="text-center mt-12">
          <p className="text-gray-500">
            All plans include 24/7 customer support • No hidden fees • Cancel anytime
          </p>
        </div>
      </div>
    </section>
